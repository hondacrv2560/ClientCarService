...
import com.example.client.apiclient.Event;
import com.example.client.apiclient.MyJsonService;
...
public class ThreeDaysActivity extends ThreeDays implements Callback<List<Event>> {
